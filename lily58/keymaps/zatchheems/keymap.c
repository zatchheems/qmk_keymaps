 ...
 *                   `----------------------------'           '------''--------------------'
 */
// TODO: change left space cadet shifft to LSPO with double-tap caps 
// TODO: change bjrackets to include double-tap parens, maybe? 
 [_QWERTY] = LAYOUT( \
...
[_LOWER] = LAYOUT( \
  ...
  _______, KC_EXLM, KC_AT,   KC_S, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_TILD, \
...
[_RAISE] = LAYOUT( \
  ...
  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   _______, _______,  KC_VOLD, KC_VOLU, KC_MUTE, KC_LBRC, KC_RBRC, KC_BSLS, \
